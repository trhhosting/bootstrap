...
The carousel supports swipe gestures (left and right) using [HammerJS]({{ site.cdn.hammer }}. For this to function correctly you need to include HammerJS before Bootstrap.
